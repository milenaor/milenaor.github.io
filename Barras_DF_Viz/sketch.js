...
function draw() {
    ...
    image(img_background_mountains,0,0,width-MARGIN,FIRST_SECTION_HEIGHT);
    let bar_number = 30;
    for (let bar=0; bar<=bar_number; bar=bar+1){
        ...
        circleBar(30+bar*(width-70)/bar_number,FIRST_SECTION_HEIGHT - 30,bar_height,CIRCLE_SPACE,circle_radius);
    }
}
